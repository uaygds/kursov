...
/* ПЕРВАЯ КАРУСЕЛЬ ЗАКОНЧЕНА */ /* ВТОРАЯ КАРУСЕЛЬ НАЧАЛО */ const tableslide = document.querySelectorAll(".table__slider .table__slider-line .table__slide");
...
/* ВТОРАЯ КАРУСЕЛЬ ЗАКОНЧЕНА */ /*LABELS FOR SLIDE*/ document.getElementById("one").onclick = function() {
...
/*LABELS FOR TABLE__SLIDE*/ document.getElementById("table__one").onclick = function() {
...
/* Конец адптивных гавно-каруселей */ document.getElementById("burger").onclick = function() {
    /*При клике на бургер, раскрываем адаптивную шапку и показываем крестик и убираем бургер */ document.getElementById("alt-nav").classList.add("alt-nav-active");
...
document.getElementById("close").onclick = function() {
    /*При клике на крестик, закрываем адаптивную шапку и возвращаем бургер */ document.getElementById("burger").classList.remove("burger-close");
