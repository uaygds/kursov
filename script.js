...
/* Конец адптивной гавно-карусели */
  ...
  document.getElementById('burger').onclick = function() { /*При клике на бургер, раскрываем адаптивную шапку и показываем крестик и убираем бургер */
  ...
  document.getElementById('close').onclick = function() { /*При клике на крестик, закрываем адаптивную шапку и возвращаем бургер */
...
function map() {
    var map = new ymaps.Map('map', {
        center: [53.92474385986169,27.509528075560763],
        zoom: 12
    });

    var placemark = new ymaps.Placemark([53.92474385986169,27.509528075560763], {
